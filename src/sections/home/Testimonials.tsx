  ...
  return (
    <section className="border-x border-black/10 mx-8 flex flex-col py-24 md:py-36">
      <div className="flex items-center gap-2 flex-row">
        ...
        <p className="text-neutral-500">Hear From Our Clients</p>
      </div>
      <div className="flex mt-8 px-4 sm:px-12 lg:px-20 flex-col gap-20">
        <div className="flex flex-col items-start">
          <div className="space-y-4 md:space-y-6">
            ...
            <p className="text-xl max-w-3xl text-neutral-700">
